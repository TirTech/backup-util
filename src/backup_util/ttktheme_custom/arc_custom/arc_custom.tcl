...
#  Derived from https://github.com/horst3180/arc_custom-theme/ under the GNU GPLv3
#  Thus this is available under GNU GPLv3 also, as described in LICENSE

namespace eval ttk::theme::arc_custom {
    ...
    LoadImages [file join [file dirname [info script]] arc_custom]

    ttk::style theme create arc_custom -parent default -settings {
        ttk::style configure . \
...
package provide ttk::theme::arc_custom $version
